...
{
    internal static List<FolderData> Get(IFolderInfo folder, string searchPatterns)
    {
    ...
    private static List<FolderData> Get(IFolderInfo folder, IEnumerable<IFileInfo> files)
    {
        var folders = files
            .Select(f => f.Folder)
    ...
    private static FolderData GetFolderInfo(IFolderInfo folder, IEnumerable<IFileInfo> allFiles)
    {
    ...
    private static IEnumerable<IFileInfo> GetFolderFiles(IFolderInfo folder, IEnumerable<IFileInfo> files)
